...
if __name__ == "__main__":
    ...
    proc_0 = streaming(sdr_0, buf_0, args.num_samp, start_time, args.run_time)
    producer_0 = multiprocessing.Process(target=asyncio.run, args=(proc_0,))
    proc_1 = streaming(sdr_1, buf_1, args.num_samp, start_time, args.run_time)
    ...
    post_process(raw_output, args.rate, args.fc, args.nfft, args.num_samp, args.mode)
